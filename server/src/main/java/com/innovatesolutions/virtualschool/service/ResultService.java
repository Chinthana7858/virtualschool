...
public class ResultService {
    ...
    public Result getResult(String subjectId, String classId, String userid, String term) {
    ...
    public Result saveResult(Result result) {
        Optional<Result> existingResultOptional = resultRepository.findBySubjectIdAndClassIdAndUseridAndTerm(result.getSubjectId(), result.getClassId(), result.getUserid(), result.getTerm());
