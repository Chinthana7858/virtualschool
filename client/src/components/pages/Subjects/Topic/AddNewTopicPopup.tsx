...
interface AddNewTopicPopupProps {
  subjectId:string;
}

function AddNewTopicPopup(props: AddNewTopicPopupProps) {
      ...
      <div className="bg-blue-50">
        ...
        <div className='flex'>
          <div className="basis-1/3">
            ...
            <p className="p-[13.5px]">Topic Name</p>
          </div>
          <div className="basis-2/3">
            <form onSubmit={handleSubmit}>
            
              <input type="text" name="topicName" value={formValues.topicName} className="p-1 m-2 border rounded-md border-slate-400" onChange={handleInputChange} />
