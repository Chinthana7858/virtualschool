...
const Footer = () => {
  return (
    ...
    <footer className=" bg-[#533E80] sm:max-w-[800px] md:max-w-[1000px] lg:max-w-[1300px] xl:max-w-[1500px] 2xl:max-w-[1700px] 2xl:max-h-[368px] xl:max-h-[330px] lg:max-h-[320px] md:max-h-[300px] sm:max-h-[290px] xs:max-h-[280px] ">
       
        <div className='flex ml-[45%] pt-[5%] xs:scale-75 xs:ml-[30%]'>
        ...
        <div className='flex text-white ml-[40%] mt-[1%] xs:scale-75 xs:ml-[15%]'>
        ...
        <div className="text-yellow-300 pt-[30px] xs:scale-75">© Innovate Solutions 2023</div>
        ...
        <div className="flex ">  
        <svg  className="ml-10 cursor-pointer 2xl:w-9 2xl:h-8 xl:w-7 xl:h-7 lg:w-6 lg:h-6 md:w-4 md:h-4 sm:w-4 sm:h-4 xs:w-4 xs:h-4"  onClick={() => {
      window.location.href = 'https://www.instagram.com/';
        ...
        <svg  className="cursor-pointer ml-7 2xl:w-7 2xl:h-7 xl:w-6 xl:h-6 lg:w-5 lg:h-5 md:w-4 md:h-4 sm:w-4 sm:h-4 xs:w-4 xs:h-4" onClick={() => {
      window.location.href = 'https://www.facebook.com/';
        ...
        <svg  className="ml-10 cursor-pointer 2xl:w-7 2xl:h-7 xl:w-6 xl:h-6 lg:w-5 lg:h-5 md:w-4 md:h-4 sm:w-4 sm:h-4 xs:w-4 xs:h-4" onClick={() => {
      window.location.href = 'https://www.linkedin.com/';
        ...
        <svg  className="mr-8 cursor-pointer ml-11 2xl:w-7 2xl:h-7 xl:w-6 xl:h-6 lg:w-5 lg:h-5 md:w-4 md:h-4 sm:w-4 sm:h-4 xs:w-4 xs:h-4" onClick={() => {
