...
const Footer = () => {
  return (
    ...
    <footer className=" bg-[#533E80] sm:max-w-[800px] md:max-w-[1000px] lg:max-w-[1300px] xl:max-w-[1500px] 2xl:max-w-[1700px] h-[368px] ">
        ...
        <div className="text-yellow-300 pt-[30px] pl-[43%]">© Innovate Solutions 2023</div>


        <div className="flex pt-[24px] ">
        <div className='h-10 w-[43%] bg-[#423265]  rounded-tr-full '></div> 
      ...
      window.location.href = 'https://www.twitter.com/';
        ...
        <div className='h-10 w-[43%] bg-[#423265]  rounded-tl-full'></div>
        </div>
    </footer>
